...
- "I love this movie" and "I would recommend it" --> "I" occurred 2 times, "movie" 1 time, ...
- NB is a probabilistic classifier.
...
```{r cnfsn_mtrx_kable, echo=FALSE, error=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
...
The categories are far away from being uniformly distributed nor are the category sizes in the sample the same size as in the original data set.
